	...
	function buildWidget($woeid,$units,$location,$forecast,$condensed) {
		...
		if($location){
		  ...
		  if($conditions['current']['region'] != ''){
		   ...
		   if(!$condensed) { echo '<p class="weathercom-link"><a href="http://weather.yahoo.com" title="Weather data provided by Yahoo! Weather">Yahoo! Weather</a></p>'; }
		}
		echo '</div></div>';
